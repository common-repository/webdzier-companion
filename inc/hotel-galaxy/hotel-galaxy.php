...
require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/functions.php';
require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/sections/home-slider.php';
require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/sections/home-service.php';
require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/sections/home-room.php';
require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/sections/home-blogs.php';
require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/sections/home-contact.php';


require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/customizer/customizer.php';


if( !defined('HG_PREMIUM_VERSION') ){

	require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/features/slider.php';
	require_once webdzierc_plugin_dir . 'inc/hotel-galaxy/features/room.php';
