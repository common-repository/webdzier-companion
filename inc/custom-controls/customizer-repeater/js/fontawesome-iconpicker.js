(function ($) {
    'use strict';
    wp.hotelgalaxycustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                hotelgalaxy_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.hotelgalaxycustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.hotelgalaxycustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.hotelgalaxycustomizerRepeater.iconPickerToggle($(this));
        });
